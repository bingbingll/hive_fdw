...
//        ResultSetMetaData result_set_metadata;
        ...
        try {
            ...
            System.out.println("path-->" + jarfile_path);
            ...
            System.out.println(HiveDriver.getClass().getName());
            ...
            System.out.println(initialize_exception.getLocalizedMessage());
            return (new String("ConnInitialize->" + exception_stack_trace_string_writer.toString()));
        }
        return null;
    }
    ...
    /*
     * Initialize Initiates the connection to the foreign database after setting
     *		up initial configuration and executes the query.
     */
    public String Execute_Query(String query) throws IOException {
//        DatabaseMetaData db_metadata;
        ResultSetMetaData result_set_metadata;
//        Properties HiveProperties;
...
//        Driver HiveDriver = null;
        ...
        try {
            ...
            initialize_exception.printStackTrace(exception_stack_trace_print_writer);
            System.out.println(initialize_exception.getLocalizedMessage());
            return (new String("Execute_Query->" + exception_stack_trace_string_writer.toString()));
        }
        return null;
    }
    ...
    public String[] ReturnResultSet() {
        ...
        try {
            ...
            System.out.println(returnresultset_exception.getLocalizedMessage());
        }
    ...
    /*
     * Close Releases the resources used.
     */
    public String Close() {
        ...
        try {
            ...
            return (new String("Close->" + exception_stack_trace_string_writer.toString()));
        }
    ...
    public String Cancel() {
        ...
        try {
            ...
            return (new String("Cancel->" + exception_stack_trace_string_writer.toString()));
        }
     ...
     **   to the caller.
     **/
    public String PrepareDDLStmtList(String schema, String servername) throws IOException {
        DatabaseMetaData db_metadata;
        ResultSetMetaData result_set_metadata;
...
//        Driver HiveDriver = null;
        ...
        try {
            ...
            initialize_exception.printStackTrace(exception_stack_trace_print_writer);
            System.out.println(initialize_exception.getLocalizedMessage());
            initialize_exception.printStackTrace();
            return (new String("PrepareDDLStmtList->" + exception_stack_trace_string_writer.toString()));
        }
    ...
    public String[] ReturnDDLStmtList() {
        int i = 0;
        return Iterate;
    }
}
